	...
	<br>
		<div class="container_16">
			...
			<div id="dados_os" class="grid_8 ui-widget-content ui-corner-all">
				<div class="title ui-widget-header ui-corner-all">Situaçção da ordem de serviçço</div>
				<div class="em_aberto_item white" style="text-align: center">
				<? 
					switch($OsStatus){
						case 0:
			...
			<div id="dados_os" class="grid_8 ui-widget-content ui-corner-all">
				<div class="title ui-widget-header ui-corner-all">Observaçães sobre OS</div>
				<div class="em_aberto_item white" style="text-align: center">
			...
			<div id="dados_pagamento" class="grid_8 ui-widget-content ui-corner-all">
				<div class="title ui-widget-header ui-corner-all">Informaçães de pagamento</div>
				<div class="em_aberto_item white">
					<table class="boxDialog">
						<tr>
