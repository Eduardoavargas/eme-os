...
<div id="pos" title="Pesquisar ordem de serviço" class="hide">
	...
	<fieldset>
		<table class="boxDialog" width="100%">
			<tr>
				<td width="200px"><label for="nome">Nº da Ordem de Serviço</label></td>
				<td>Placa/Veículo</td>
			</tr>
			<tr>
...
<!-- Inicio - Dialog configuraçções -->
<div id="configuracoes" title="Configuraçaões" class="hide">
